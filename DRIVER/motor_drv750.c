...
{
	return Modbus_Request_Write_Single_Register(addr, P06_00, hz); // 0~65535
}
uint8_t *DRV750_VELOCITY_PID_I(uint8_t addr, uint16_t ms)
{
	return Modbus_Request_Write_Single_Register(addr, P06_01, ms); // 0~30000
}
uint8_t *DRV750_POSITION_PID_P(uint8_t addr, uint16_t hz)
{
	return Modbus_Request_Write_Single_Register(addr, P06_02, hz); // 0~30000
}
/*********************************P13************************************/
